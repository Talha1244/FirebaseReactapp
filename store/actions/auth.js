...
export const signUp = (email, password) => {
  return async (dispatch) => {
    const response = await fetch(
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCc7QjIiKZVdO4yxV9Og5teijUeL-LtDLk',
      {
        method: 'POST',
        headers: {
...
export const signIn = (email, password) => {
  return async (dispatch) => {
    const response = await fetch(
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCc7QjIiKZVdO4yxV9Og5teijUeL-LtDLk',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
